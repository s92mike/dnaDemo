        ...
        <ul className='navbar-nav mr-auto'>
          <li className='nav-item'>
            <NavLink className='nav-link' activeClassName='active'
              exact to='/'>Home <span className='sr-only'>(current)</span></NavLink>
          </li>
          <li className='nav-item'>
            <NavLink className='nav-link' activeClassName='active'
              to='/inventory'>Item List</NavLink>
          </li>
          <li className='nav-item'>
            <NavLink className='nav-link' activeClassName='active'
              to='/vendor-center'>Vendor Center</NavLink>
          </li>
          <li className='nav-item'>
            <NavLink className='nav-link' activeClassName='active'
              to='/customer'>Customer Center</NavLink>
          </li>
          <li className='nav-item'>
